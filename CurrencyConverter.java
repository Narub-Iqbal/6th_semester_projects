...
public class CurrencyConverter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Convert.setBackground(new java.awt.Color(11, 186, 37));
        ...
        txtFrom.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "USD", "PKR", "INR", "YEN" }));
        ...
        txtTo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PKR", "USD", "INR", "YEN" }));
    ...
    private void ConvertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConvertActionPerformed
        ...
        if(txtFrom.getSelectedItem().toString()=="USD" && txtTo.getSelectedItem().toString()=="PKR"){
            convert = amount * 200;
            ...
            convert = amount * 0.0048;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" USD");
        }
            else if(txtFrom.getSelectedItem().toString()=="INR" && txtTo.getSelectedItem().toString()=="PKR"){
            convert = amount * 2.66;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" PKR");
        }
        else if(txtFrom.getSelectedItem().toString()=="PKR" && txtTo.getSelectedItem().toString()=="INR"){
            convert = amount * 0.38;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" INR");
        }
         else if(txtFrom.getSelectedItem().toString()=="PKR" && txtTo.getSelectedItem().toString()=="YEN"){
            convert = amount * 0.65;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" YEN");
        }
        else if(txtFrom.getSelectedItem().toString()=="YEN" && txtTo.getSelectedItem().toString()=="PKR"){
            convert = amount * 1.54;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" PKR");
        }
        else if(txtFrom.getSelectedItem().toString()=="USD" && txtTo.getSelectedItem().toString()=="INR"){
            convert = amount * 78.25;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" INR");
        }
        else if(txtFrom.getSelectedItem().toString()=="INR" && txtTo.getSelectedItem().toString()=="USD"){
            convert = amount * 0.013;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" USD");
        }
        else if(txtFrom.getSelectedItem().toString()=="YEN" && txtTo.getSelectedItem().toString()=="INR"){
            convert = amount * 11.70;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" INR");
        }
        else if(txtFrom.getSelectedItem().toString()=="INR" && txtTo.getSelectedItem().toString()=="YEN"){
            convert = amount * 0.085;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" YEN");
        }
